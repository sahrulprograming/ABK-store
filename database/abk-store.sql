...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Nov 2022 pada 08.14
...
INSERT INTO `cart` (`id`, `product_id`, `ip_address`, `user_id`, `qty`) VALUES
(10, 45, '::1', 55, 2),
(11, 45, '::1', 55, 2);
...
CREATE TABLE `orders` (
  `invoice` varchar(24) NOT NULL,
  `user_id` int(11) NOT NULL,
  `bukti` varchar(45) NOT NULL,
  `status_pembayaran` varchar(20) NOT NULL DEFAULT 'menunggu'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `orders` (`invoice`, `user_id`, `bukti`, `status_pembayaran`) VALUES
('INV_1669000222', 54, 'bukti_1669000222.png', 'confirmed'),
('INV_1669000376', 54, 'bukti_1669000376.png', 'reject');
...
INSERT INTO `order_products` (`invoice`, `product_id`, `qty`, `amount`) VALUES
('INV_1669000222', 79, 3, '7707'),
('INV_1669000376', 1, 1, '5000'),
('INV_1669000376', 6, 1, '35000'),
('INV_1669000376', 45, 1, '10000');
...
(81, 4, 6, 'Kids blue dress', 30000, '<p>blue dress</p>', '1543993724_pg4.jpg', 'kids blue dress');
...
INSERT INTO `user_info` (`user_id`, `role_id`, `first_name`, `last_name`, `image`, `email`, `password`, `phone_number`, `address`, `city`) VALUES
(54, 1, 'admin', 'ABK-store', 'default.jpg', 'admin@gmail.com', '$2y$10$LEBHCnko.bekCwjJleqOp.Ov.2Zf7kw6qowJQsOvuKovX4.m/e7W6', NULL, NULL, NULL),
(55, 2, 'kiki', 'riswanto', 'default.jpg', 'kiki@gmail.com', '$2y$10$OAqnaN75mtQTO739zCbe3.F/jswqWazEvkS1KIzFjoh1wzHoiSnV.', NULL, NULL, NULL);
...
ALTER TABLE `order_products`
  ADD KEY `order_products` (`invoice`),
...
--
ALTER TABLE `order_products`
  ADD CONSTRAINT `invoice` FOREIGN KEY (`invoice`) REFERENCES `orders` (`invoice`) ON DELETE CASCADE ON UPDATE CASCADE,
